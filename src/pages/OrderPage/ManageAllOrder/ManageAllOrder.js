...
const ManageAllOrder = () => {
    ...
    useEffect(()=>{
        fetch('https://safe-brushlands-03209.herokuapp.com/order/manageall')
        .then(res=>res.json())
    ...
    const handleDelete = (_id) =>{
        ...
        if (proceed) {
          ...
          const url = `https://safe-brushlands-03209.herokuapp.com/order/delete/${_id}`
          fetch(url,{
              method : 'DELETE',
      ...
      const handleStatus = (_id) =>{
        ...
        // setIsStatus(true)
        console.log(_id)
        const url = `https://safe-brushlands-03209.herokuapp.com/status/${_id}`
        fetch(url,{
            method : 'PUT',
            headers:{
